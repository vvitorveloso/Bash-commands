#!/bin/bash
#secret-tool store --label="Senha da VM RDPWindows" server RDP
...
wlfreerdp3 +window-drag +aero +home-drive  +clipboard  /smart-sizing  /d:AzureAD  /sec:tls  /sound:sys:pulse   /u:user /p:123 /w:1200 /h:608 /v:$VMIP:3389
